    ...
    <div className="w-[450px] h-[200px] bg-[#1a1a1a] border border-[#0896d8] overflow-hidden relative">
      ...
      <div className="relative z-10 p-4 flex flex-col h-full">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <button className="text-[#777777] hover:text-[#0896d8] transition-colors p-1 bg-[#101010] border border-[#333333]">
            <HelpCircle size={18} />
          </button>
          <button 
            onClick={onClose}
            className="text-[#777777] hover:text-[#0896d8] transition-colors p-1 bg-[#101010] border border-[#333333]"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="mt-3 space-y-1">
          <div className="flex items-center gap-2">
            ...
            />
            <div className="text-xs font-mono bg-[#101010] text-[#0896d8] px-2 py-1 border border-[#333333]">
