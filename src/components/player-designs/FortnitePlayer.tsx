...
const FortnitePlayer: React.FC<PlayerProps> = ({ onClose, currentSong, isPlaying, togglePlayback, currentTime }) => {
      ...
      <div className="relative z-10 p-4 flex flex-col h-full">
        ...
        <div className="flex gap-4 flex-1">
          ...
          <div className="flex flex-col justify-between flex-1">
            ...
            {/* Progress bar */}
            <div className="relative h-2 bg-[#161639] rounded-full overflow-hidden mb-1">
              <div 
                className="absolute top-0 left-0 h-full bg-gradient-to-r from-[#19cdd7] to-[#fc24ff]" 
        ...
        <div className="flex justify-end">
          <div className="bg-[#161639]/80 text-xs text-[#19cdd7] font-bold px-2 py-0.5 rounded-md">
